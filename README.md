...
- A running PSPDFKit Server (if you wish to use Server backend). Follow the [guide here](https://pspdfkit.com/guides/web/current/server-backed/setting-up-pspdfkit-server/).
